...
let favorite_animal = "red panda"
console.log("My favorite animal is the " + favorite_animal)

// Problem 4
// Create two variables: one for your first name and one for your last name.
// Print them on 2 separate lines.
let first_name = "Aanya"
let last_name = "S"
...
console.log("My name is " + name + ", I am " + age + " years old, and my favorite color is " + favorite_color)