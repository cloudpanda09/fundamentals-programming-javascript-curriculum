...
colors.push("purple"); // Adds the color purple to the list of colors
colors.push("blue"); // Adds the color purple to the list of colors
console.log("After append: ", colors)

colors.splice(2, 0, "pink"); // Adds the color pink to index 2 in the list of colors
...
let popped_color_at_index = colors.splice(1, 1)[0]; // (1, 1)[0] means go to the beginning of 1, then take index 1 as a subset, and get the 0th index of that
console.log("Popped color at index 1: " + popped_color_at_index);
console.log("After pop at index 1: " + colors)

let index_of_blue = colors.indexOf("blue");
